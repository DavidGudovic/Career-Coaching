...
export const BlogPage: GlobalConfig = {
  ...
  fields: [
    ...
    { name: 'sub', type: 'textarea', localized: true, defaultValue: 'Bilješke o promjeni karijere, prelasku u IT i pronalaženju smjera — uključujući kolumne iz magazina Ljepota i zdravlje Montenegro.' },
  ],
}
