...
export const ui: Record<Locale, Dict> = {
  me: {
    ...
    nav_blog: 'Karijerne bilješke',
    nav_contact: 'Kontakt',
    nav_resources: 'Besplatni resursi',
    resource_download: 'Preuzmi PDF',
    resource_preview: 'Pogledaj PDF',
    new_tab: 'novi tab',
    webinar_cta: 'Prijavi se za vebinar',
    webinar_close: 'Umanji poziv za vebinar',
    webinar_later: 'Kasnije',
    webinar_open: 'Pogledaj detalje vebinara',
    newsletter_title: 'Ostanimo u kontaktu',
    newsletter_cta: 'Prijavi se na newsletter',
    form_unavailable: 'Trenutno mi možeš pisati direktno na email ili zakazati razgovor.',
    ...
    blog_all: 'Sve bilješke',
    read_more: 'Pročitaj još',
    art_back: 'Sve bilješke',
    ...
    no_posts: 'Uskoro stižu nove bilješke.',
  },
  en: {
    nav_home: 'Home',
    nav_about: 'About',
    ...
    nav_contact: 'Contact',
    nav_resources: 'Free resources',
    resource_download: 'Download PDF',
    resource_preview: 'Preview PDF',
    new_tab: 'new tab',
    webinar_cta: 'Register for the webinar',
    webinar_close: 'Minimise webinar invitation',
    webinar_later: 'Later',
    webinar_open: 'View webinar details',
    newsletter_title: 'Let’s stay in touch',
    newsletter_cta: 'Subscribe to the newsletter',
    form_unavailable: 'Please email me directly or book a call for now.',
